...
# Slot: proport_woa_silicate 



URI: [img_gold:proport_woa_silicate](https://w3id.org/jgi/img_gold/proport_woa_silicate)
...
| ---  | ---  |
| self | img_gold:proport_woa_silicate |
| native | img_gold:proport_woa_silicate |
