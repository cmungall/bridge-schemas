...
# Slot: proport_woa_phosphate 



URI: [img_gold:proport_woa_phosphate](https://w3id.org/jgi/img_gold/proport_woa_phosphate)
...
| ---  | ---  |
| self | img_gold:proport_woa_phosphate |
| native | img_gold:proport_woa_phosphate |
