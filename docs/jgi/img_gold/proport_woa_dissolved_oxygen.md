...
# Slot: proport_woa_dissolved_oxygen 



URI: [img_gold:proport_woa_dissolved_oxygen](https://w3id.org/jgi/img_gold/proport_woa_dissolved_oxygen)
...
| ---  | ---  |
| self | img_gold:proport_woa_dissolved_oxygen |
| native | img_gold:proport_woa_dissolved_oxygen |
