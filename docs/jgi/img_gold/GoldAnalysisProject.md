...
URI: [img_gold:GoldAnalysisProject](https://w3id.org/jgi/img_gold/GoldAnalysisProject)
...
| [img_dataset_id](img_dataset_id.md) | 0..1 <br/> [Integer](Integer.md) |  | direct |
...
| ---  | ---  |
| self | img_gold:GoldAnalysisProject |
| native | img_gold:GoldAnalysisProject |
