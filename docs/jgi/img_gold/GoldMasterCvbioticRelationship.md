...
# Class: GoldMasterCvbioticRelationship 



URI: [img_gold:GoldMasterCvbioticRelationship](https://w3id.org/jgi/img_gold/GoldMasterCvbioticRelationship)
...
```mermaid
 classDiagram
    class GoldMasterCvbioticRelationship
    click GoldMasterCvbioticRelationship href "../GoldMasterCvbioticRelationship/"
      GoldMasterCvbioticRelationship : id
        
      GoldMasterCvbioticRelationship : term
...
| ---  | ---  |
| self | img_gold:GoldMasterCvbioticRelationship |
| native | img_gold:GoldMasterCvbioticRelationship |
...
<details>
```yaml
name: gold_master_cvbiotic_relationship
...
attributes:
  id:
    ...
    from_schema: https://w3id.org/jgi/img_gold
    alias: id
    owner: gold_master_cvbiotic_relationship
    domain_of:
    - gold_ap_genbank
    - gold_master_cvap_status
    - gold_master_cvbiotic_relationship
