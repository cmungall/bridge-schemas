...
# Class: GoldMasterCvphenotype 



URI: [img_gold:GoldMasterCvphenotype](https://w3id.org/jgi/img_gold/GoldMasterCvphenotype)
...
```mermaid
 classDiagram
    class GoldMasterCvphenotype
    click GoldMasterCvphenotype href "../GoldMasterCvphenotype/"
      GoldMasterCvphenotype : id
        
      GoldMasterCvphenotype : term
...
| ---  | ---  |
| self | img_gold:GoldMasterCvphenotype |
| native | img_gold:GoldMasterCvphenotype |
