...
# Class: GoldMasterCvseqStatus 



URI: [img_gold:GoldMasterCvseqStatus](https://w3id.org/jgi/img_gold/GoldMasterCvseqStatus)
...
```mermaid
 classDiagram
    class GoldMasterCvseqStatus
    click GoldMasterCvseqStatus href "../GoldMasterCvseqStatus/"
      GoldMasterCvseqStatus : id
        
      GoldMasterCvseqStatus : term
...
| ---  | ---  |
| self | img_gold:GoldMasterCvseqStatus |
| native | img_gold:GoldMasterCvseqStatus |
...
attributes:
  id:
    ...
    from_schema: https://w3id.org/jgi/img_gold
    alias: id
    owner: gold_master_cvseq_status
    domain_of:
    - gold_ap_genbank
    - gold_master_cvap_status
    - gold_master_cvbiotic_relationship
