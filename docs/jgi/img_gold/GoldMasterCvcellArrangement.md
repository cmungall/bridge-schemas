...
# Class: GoldMasterCvcellArrangement 



URI: [img_gold:GoldMasterCvcellArrangement](https://w3id.org/jgi/img_gold/GoldMasterCvcellArrangement)
...
```mermaid
 classDiagram
    class GoldMasterCvcellArrangement
    click GoldMasterCvcellArrangement href "../GoldMasterCvcellArrangement/"
      GoldMasterCvcellArrangement : id
        
      GoldMasterCvcellArrangement : term
...
| ---  | ---  |
| self | img_gold:GoldMasterCvcellArrangement |
| native | img_gold:GoldMasterCvcellArrangement |
...
<details>
```yaml
name: gold_master_cvcell_arrangement
...
attributes:
  id:
    ...
    from_schema: https://w3id.org/jgi/img_gold
    alias: id
    owner: gold_master_cvcell_arrangement
    domain_of:
    - gold_ap_genbank
    - gold_master_cvap_status
    - gold_master_cvbiotic_relationship
