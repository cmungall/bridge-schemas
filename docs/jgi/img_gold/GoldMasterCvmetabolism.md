...
# Class: GoldMasterCvmetabolism 



URI: [img_gold:GoldMasterCvmetabolism](https://w3id.org/jgi/img_gold/GoldMasterCvmetabolism)
...
```mermaid
 classDiagram
    class GoldMasterCvmetabolism
    click GoldMasterCvmetabolism href "../GoldMasterCvmetabolism/"
      GoldMasterCvmetabolism : id
        
      GoldMasterCvmetabolism : term
...
| ---  | ---  |
| self | img_gold:GoldMasterCvmetabolism |
| native | img_gold:GoldMasterCvmetabolism |
...
attributes:
  id:
    ...
    from_schema: https://w3id.org/jgi/img_gold
    alias: id
    owner: gold_master_cvmetabolism
    domain_of:
    - gold_ap_genbank
    - gold_master_cvap_status
    - gold_master_cvbiotic_relationship
