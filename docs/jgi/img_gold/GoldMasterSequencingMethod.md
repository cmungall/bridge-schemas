...
URI: [img_gold:GoldMasterSequencingMethod](https://w3id.org/jgi/img_gold/GoldMasterSequencingMethod)
...
| ---  | ---  |
| self | img_gold:GoldMasterSequencingMethod |
| native | img_gold:GoldMasterSequencingMethod |
