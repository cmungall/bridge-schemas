...
# Class: GoldMasterSraExperiment 



URI: [img_gold:GoldMasterSraExperiment](https://w3id.org/jgi/img_gold/GoldMasterSraExperiment)
...
```mermaid
 classDiagram
    class GoldMasterSraExperiment
    click GoldMasterSraExperiment href "../GoldMasterSraExperiment/"
      GoldMasterSraExperiment : project_id
        
      GoldMasterSraExperiment : sra_experiment_id
...
| ---  | ---  |
| self | img_gold:GoldMasterSraExperiment |
| native | img_gold:GoldMasterSraExperiment |
...
<details>
```yaml
name: gold_master_sra_experiment
...
attributes:
  project_id:
    ...
    from_schema: https://w3id.org/jgi/img_gold
    alias: project_id
    owner: gold_master_sra_experiment
    domain_of:
    - gold_master_hmp_project
    - gold_master_permission
    - gold_master_project
