...
# Class: GoldMasterCvenergySource 



URI: [img_gold:GoldMasterCvenergySource](https://w3id.org/jgi/img_gold/GoldMasterCvenergySource)
...
```mermaid
 classDiagram
    class GoldMasterCvenergySource
    click GoldMasterCvenergySource href "../GoldMasterCvenergySource/"
      GoldMasterCvenergySource : id
        
      GoldMasterCvenergySource : term
...
| ---  | ---  |
| self | img_gold:GoldMasterCvenergySource |
| native | img_gold:GoldMasterCvenergySource |
...
<details>
```yaml
name: gold_master_cvenergy_source
...
attributes:
  id:
    ...
    from_schema: https://w3id.org/jgi/img_gold
    alias: id
    owner: gold_master_cvenergy_source
    domain_of:
    - gold_ap_genbank
    - gold_master_cvap_status
    - gold_master_cvbiotic_relationship
