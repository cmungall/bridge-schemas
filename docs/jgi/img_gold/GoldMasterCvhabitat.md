...
# Class: GoldMasterCvhabitat 



URI: [img_gold:GoldMasterCvhabitat](https://w3id.org/jgi/img_gold/GoldMasterCvhabitat)
...
```mermaid
 classDiagram
    class GoldMasterCvhabitat
    click GoldMasterCvhabitat href "../GoldMasterCvhabitat/"
      GoldMasterCvhabitat : id
        
      GoldMasterCvhabitat : term
...
| ---  | ---  |
| self | img_gold:GoldMasterCvhabitat |
| native | img_gold:GoldMasterCvhabitat |
