...
# Class: GoldMasterCvdisease 



URI: [img_gold:GoldMasterCvdisease](https://w3id.org/jgi/img_gold/GoldMasterCvdisease)
...
```mermaid
 classDiagram
    class GoldMasterCvdisease
    click GoldMasterCvdisease href "../GoldMasterCvdisease/"
      GoldMasterCvdisease : id
        
      GoldMasterCvdisease : term
...
| ---  | ---  |
| self | img_gold:GoldMasterCvdisease |
| native | img_gold:GoldMasterCvdisease |
