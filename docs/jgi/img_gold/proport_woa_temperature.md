...
URI: [img_gold:proport_woa_temperature](https://w3id.org/jgi/img_gold/proport_woa_temperature)
...
| ---  | ---  |
| self | img_gold:proport_woa_temperature |
| native | img_gold:proport_woa_temperature |
