...
# Class: GoldMasterLonghurstCode 



URI: [img_gold:GoldMasterLonghurstCode](https://w3id.org/jgi/img_gold/GoldMasterLonghurstCode)
...
```mermaid
 classDiagram
    class GoldMasterLonghurstCode
    click GoldMasterLonghurstCode href "../GoldMasterLonghurstCode/"
      GoldMasterLonghurstCode : description
        
      GoldMasterLonghurstCode : id
        
      GoldMasterLonghurstCode : term
...
| ---  | ---  |
| self | img_gold:GoldMasterLonghurstCode |
| native | img_gold:GoldMasterLonghurstCode |
...
<details>
```yaml
name: gold_master_longhurst_code
...
attributes:
  id:
    ...
    from_schema: https://w3id.org/jgi/img_gold
    alias: id
    owner: gold_master_longhurst_code
    domain_of:
    - gold_ap_genbank
    - gold_master_cvap_status
    - gold_master_cvbiotic_relationship
