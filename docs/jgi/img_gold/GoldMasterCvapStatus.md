...
# Class: GoldMasterCvapStatus 



URI: [img_gold:GoldMasterCvapStatus](https://w3id.org/jgi/img_gold/GoldMasterCvapStatus)
...
```mermaid
 classDiagram
    class GoldMasterCvapStatus
    click GoldMasterCvapStatus href "../GoldMasterCvapStatus/"
      GoldMasterCvapStatus : id
        
      GoldMasterCvapStatus : term
...
| ---  | ---  |
| self | img_gold:GoldMasterCvapStatus |
| native | img_gold:GoldMasterCvapStatus |
