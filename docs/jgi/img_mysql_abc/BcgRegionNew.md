...
URI: [img_mysql_abc:BcgRegionNew](https://w3id.org/jgi/img_mysql_abc/BcgRegionNew)
...
```mermaid
 classDiagram
    class BcgRegionNew
    click BcgRegionNew href "../BcgRegionNew/"
      BcgRegionNew : add_date
        
      BcgRegionNew : bcg_method
        
      BcgRegionNew : bcg_rules
        
      BcgRegionNew : bcg_type
        
      BcgRegionNew : end_coord
        
      BcgRegionNew : region_id
        
      BcgRegionNew : scaffold_oid
        
      BcgRegionNew : seq_id
        
      BcgRegionNew : start_coord
        
      BcgRegionNew : taxon_oid
...
| ---  | ---  |
| self | img_mysql_abc:BcgRegionNew |
| native | img_mysql_abc:BcgRegionNew |
