...
URI: [imgsg_dev:ProjectGoalcv](https://w3id.org/jgi/imgsg_dev/ProjectGoalcv)
...
```mermaid
 classDiagram
    class ProjectGoalcv
    click ProjectGoalcv href "../ProjectGoalcv/"
      ProjectGoalcv : cv_term
...
| ---  | ---  |
| self | imgsg_dev:ProjectGoalcv |
| native | imgsg_dev:ProjectGoalcv |
