...
URI: [imgsg_dev:SampleTypecv](https://w3id.org/jgi/imgsg_dev/SampleTypecv)
...
```mermaid
 classDiagram
    class SampleTypecv
    click SampleTypecv href "../SampleTypecv/"
      SampleTypecv : cv_term
...
| ---  | ---  |
| self | imgsg_dev:SampleTypecv |
| native | imgsg_dev:SampleTypecv |
