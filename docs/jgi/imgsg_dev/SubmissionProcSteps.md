...
URI: [imgsg_dev:SubmissionProcSteps](https://w3id.org/jgi/imgsg_dev/SubmissionProcSteps)
...
| ---  | ---  |
| self | imgsg_dev:SubmissionProcSteps |
| native | imgsg_dev:SubmissionProcSteps |
