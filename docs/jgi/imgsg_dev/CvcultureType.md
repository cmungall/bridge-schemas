...
URI: [imgsg_dev:CvcultureType](https://w3id.org/jgi/imgsg_dev/CvcultureType)
...
```mermaid
 classDiagram
    class CvcultureType
    click CvcultureType href "../CvcultureType/"
      CvcultureType : cv_term
...
| ---  | ---  |
| self | imgsg_dev:CvcultureType |
| native | imgsg_dev:CvcultureType |
