...
# Class: ProjectInfoHabitat 



URI: [imgsg_dev:ProjectInfoHabitat](https://w3id.org/jgi/imgsg_dev/ProjectInfoHabitat)
...
```mermaid
 classDiagram
    class ProjectInfoHabitat
    click ProjectInfoHabitat href "../ProjectInfoHabitat/"
      ProjectInfoHabitat : habitat
        
      ProjectInfoHabitat : project_oid
...
| ---  | ---  |
| self | imgsg_dev:ProjectInfoHabitat |
| native | imgsg_dev:ProjectInfoHabitat |
