...
URI: [imgsg_dev:CellShapecv](https://w3id.org/jgi/imgsg_dev/CellShapecv)
...
```mermaid
 classDiagram
    class CellShapecv
    click CellShapecv href "../CellShapecv/"
      CellShapecv : cv_term
...
| ---  | ---  |
| self | imgsg_dev:CellShapecv |
| native | imgsg_dev:CellShapecv |
