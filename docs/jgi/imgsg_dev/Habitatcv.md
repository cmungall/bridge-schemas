...
URI: [imgsg_dev:Habitatcv](https://w3id.org/jgi/imgsg_dev/Habitatcv)
...
```mermaid
 classDiagram
    class Habitatcv
    click Habitatcv href "../Habitatcv/"
      Habitatcv : cv_term
...
| [envo_id](envo_id.md) | 0..1 <br/> [String](String.md) |  | direct |
...
| ---  | ---  |
| self | imgsg_dev:Habitatcv |
| native | imgsg_dev:Habitatcv |
