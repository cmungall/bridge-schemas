...
# Class: DiseasecvParents 



URI: [imgsg_dev:DiseasecvParents](https://w3id.org/jgi/imgsg_dev/DiseasecvParents)
...
```mermaid
 classDiagram
    class DiseasecvParents
    click DiseasecvParents href "../DiseasecvParents/"
      DiseasecvParents : cv_term
        
      DiseasecvParents : parents
...
| ---  | ---  |
| self | imgsg_dev:DiseasecvParents |
| native | imgsg_dev:DiseasecvParents |
