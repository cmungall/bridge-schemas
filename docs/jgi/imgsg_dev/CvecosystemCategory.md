...
# Class: CvecosystemCategory 



URI: [imgsg_dev:CvecosystemCategory](https://w3id.org/jgi/imgsg_dev/CvecosystemCategory)
...
```mermaid
 classDiagram
    class CvecosystemCategory
    click CvecosystemCategory href "../CvecosystemCategory/"
      CvecosystemCategory : cv_term
        
      CvecosystemCategory : ecosystem_category
...
| ---  | ---  |
| self | imgsg_dev:CvecosystemCategory |
| native | imgsg_dev:CvecosystemCategory |
