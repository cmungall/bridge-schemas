...
URI: [imgsg_dev:Cvecosystem](https://w3id.org/jgi/imgsg_dev/Cvecosystem)
...
```mermaid
 classDiagram
    class Cvecosystem
    click Cvecosystem href "../Cvecosystem/"
      Cvecosystem : cv_term
        
      Cvecosystem : ecosystem
...
| ---  | ---  |
| self | imgsg_dev:Cvecosystem |
| native | imgsg_dev:Cvecosystem |
