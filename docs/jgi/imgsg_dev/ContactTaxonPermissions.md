...
URI: [imgsg_dev:ContactTaxonPermissions](https://w3id.org/jgi/imgsg_dev/ContactTaxonPermissions)
...
| ---  | ---  |
| self | imgsg_dev:ContactTaxonPermissions |
| native | imgsg_dev:ContactTaxonPermissions |
