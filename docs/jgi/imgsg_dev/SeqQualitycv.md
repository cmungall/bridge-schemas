...
URI: [imgsg_dev:SeqQualitycv](https://w3id.org/jgi/imgsg_dev/SeqQualitycv)
...
```mermaid
 classDiagram
    class SeqQualitycv
    click SeqQualitycv href "../SeqQualitycv/"
      SeqQualitycv : cv_term
...
| ---  | ---  |
| self | imgsg_dev:SeqQualitycv |
| native | imgsg_dev:SeqQualitycv |
