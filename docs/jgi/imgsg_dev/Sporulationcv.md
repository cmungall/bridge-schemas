...
URI: [imgsg_dev:Sporulationcv](https://w3id.org/jgi/imgsg_dev/Sporulationcv)
...
```mermaid
 classDiagram
    class Sporulationcv
    click Sporulationcv href "../Sporulationcv/"
      Sporulationcv : cv_term
...
| ---  | ---  |
| self | imgsg_dev:Sporulationcv |
| native | imgsg_dev:Sporulationcv |
