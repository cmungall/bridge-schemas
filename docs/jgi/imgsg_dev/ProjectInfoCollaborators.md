...
# Class: ProjectInfoCollaborators 



URI: [imgsg_dev:ProjectInfoCollaborators](https://w3id.org/jgi/imgsg_dev/ProjectInfoCollaborators)
...
```mermaid
 classDiagram
    class ProjectInfoCollaborators
    click ProjectInfoCollaborators href "../ProjectInfoCollaborators/"
      ProjectInfoCollaborators : collaborator_id
        
      ProjectInfoCollaborators : project_oid
...
| ---  | ---  |
| self | imgsg_dev:ProjectInfoCollaborators |
| native | imgsg_dev:ProjectInfoCollaborators |
...
<details>
```yaml
name: project_info_collaborators
...
attributes:
  project_oid:
    ...
    from_schema: https://w3id.org/jgi/imgsg_dev
    alias: project_oid
    owner: project_info_collaborators
    domain_of:
    - bioproject_propagation
    - biosample
    - data_quality_flags
