...
URI: [imgsg_dev:ContactProtexpPermissions](https://w3id.org/jgi/imgsg_dev/ContactProtexpPermissions)
...
| ---  | ---  |
| self | imgsg_dev:ContactProtexpPermissions |
| native | imgsg_dev:ContactProtexpPermissions |
