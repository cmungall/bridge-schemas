...
URI: [imgsg_dev:BeiStatuscv](https://w3id.org/jgi/imgsg_dev/BeiStatuscv)
...
```mermaid
 classDiagram
    class BeiStatuscv
    click BeiStatuscv href "../BeiStatuscv/"
      BeiStatuscv : cv_term
...
| ---  | ---  |
| self | imgsg_dev:BeiStatuscv |
| native | imgsg_dev:BeiStatuscv |
