...
URI: [imgsg_dev:ProjectTypecv](https://w3id.org/jgi/imgsg_dev/ProjectTypecv)
...
```mermaid
 classDiagram
    class ProjectTypecv
    click ProjectTypecv href "../ProjectTypecv/"
      ProjectTypecv : cv_term
...
| ---  | ---  |
| self | imgsg_dev:ProjectTypecv |
| native | imgsg_dev:ProjectTypecv |
