...
URI: [imgsg_dev:Relevancecv](https://w3id.org/jgi/imgsg_dev/Relevancecv)
...
```mermaid
 classDiagram
    class Relevancecv
    click Relevancecv href "../Relevancecv/"
      Relevancecv : cv_term
...
| ---  | ---  |
| self | imgsg_dev:Relevancecv |
| native | imgsg_dev:Relevancecv |
