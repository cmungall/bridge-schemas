...
URI: [imgsg_dev:LibraryInfocv](https://w3id.org/jgi/imgsg_dev/LibraryInfocv)
...
```mermaid
 classDiagram
    class LibraryInfocv
    click LibraryInfocv href "../LibraryInfocv/"
      LibraryInfocv : cv_term
...
| ---  | ---  |
| self | imgsg_dev:LibraryInfocv |
| native | imgsg_dev:LibraryInfocv |
