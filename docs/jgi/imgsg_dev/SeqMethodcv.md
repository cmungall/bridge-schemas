...
URI: [imgsg_dev:SeqMethodcv](https://w3id.org/jgi/imgsg_dev/SeqMethodcv)
...
```mermaid
 classDiagram
    class SeqMethodcv
    click SeqMethodcv href "../SeqMethodcv/"
      SeqMethodcv : cv_term
...
| ---  | ---  |
| self | imgsg_dev:SeqMethodcv |
| native | imgsg_dev:SeqMethodcv |
