...
# Class: ProjectInfoProjectRelevance 



URI: [imgsg_dev:ProjectInfoProjectRelevance](https://w3id.org/jgi/imgsg_dev/ProjectInfoProjectRelevance)
...
```mermaid
 classDiagram
    class ProjectInfoProjectRelevance
    click ProjectInfoProjectRelevance href "../ProjectInfoProjectRelevance/"
      ProjectInfoProjectRelevance : project_oid
        
          
    
        
        
        ProjectInfoProjectRelevance --> "0..1" ProjectInfo : project_oid
        click ProjectInfo href "../ProjectInfo/"
    

        
      ProjectInfoProjectRelevance : project_relevance
...
| ---  | ---  |
| self | imgsg_dev:ProjectInfoProjectRelevance |
| native | imgsg_dev:ProjectInfoProjectRelevance |
...
<details>
```yaml
name: project_info_project_relevance
...
attributes:
  project_oid:
    ...
    from_schema: https://w3id.org/jgi/imgsg_dev
    alias: project_oid
    owner: project_info_project_relevance
    domain_of:
    - bioproject_propagation
    - biosample
    - data_quality_flags
