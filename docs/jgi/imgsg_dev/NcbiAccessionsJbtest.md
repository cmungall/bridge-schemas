...
# Class: NcbiAccessionsJbtest 



URI: [imgsg_dev:NcbiAccessionsJbtest](https://w3id.org/jgi/imgsg_dev/NcbiAccessionsJbtest)
...
```mermaid
 classDiagram
    class NcbiAccessionsJbtest
    click NcbiAccessionsJbtest href "../NcbiAccessionsJbtest/"
      NcbiAccessionsJbtest : accession_id
        
      NcbiAccessionsJbtest : assembly_accession
        
      NcbiAccessionsJbtest : bioproject_accession
        
      NcbiAccessionsJbtest : project_oid
        
      NcbiAccessionsJbtest : scaffold_source
        
      NcbiAccessionsJbtest : type
...
| ---  | ---  |
| self | imgsg_dev:NcbiAccessionsJbtest |
| native | imgsg_dev:NcbiAccessionsJbtest |
