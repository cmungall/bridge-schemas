...
# Class: ProjectStatuscv 



URI: [imgsg_dev:ProjectStatuscv](https://w3id.org/jgi/imgsg_dev/ProjectStatuscv)
...
```mermaid
 classDiagram
    class ProjectStatuscv
    click ProjectStatuscv href "../ProjectStatuscv/"
      ProjectStatuscv : cv_term
...
| ---  | ---  |
| self | imgsg_dev:ProjectStatuscv |
| native | imgsg_dev:ProjectStatuscv |
