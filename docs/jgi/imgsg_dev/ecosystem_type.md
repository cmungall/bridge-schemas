...
URI: [imgsg_dev:ecosystem_type](https://w3id.org/jgi/imgsg_dev/ecosystem_type)
...
| [CvecosystemType](CvecosystemType.md) |  |  no  |
...
| ---  | ---  |
| self | imgsg_dev:ecosystem_type |
| native | imgsg_dev:ecosystem_type |
