...
URI: [imgsg_dev:AnnotationStepStats](https://w3id.org/jgi/imgsg_dev/AnnotationStepStats)
...
| ---  | ---  |
| self | imgsg_dev:AnnotationStepStats |
| native | imgsg_dev:AnnotationStepStats |
