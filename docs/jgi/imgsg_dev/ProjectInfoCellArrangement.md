...
# Class: ProjectInfoCellArrangement 



URI: [imgsg_dev:ProjectInfoCellArrangement](https://w3id.org/jgi/imgsg_dev/ProjectInfoCellArrangement)
...
```mermaid
 classDiagram
    class ProjectInfoCellArrangement
    click ProjectInfoCellArrangement href "../ProjectInfoCellArrangement/"
      ProjectInfoCellArrangement : cell_arrangement
        
      ProjectInfoCellArrangement : project_oid
...
| ---  | ---  |
| self | imgsg_dev:ProjectInfoCellArrangement |
| native | imgsg_dev:ProjectInfoCellArrangement |
...
<details>
```yaml
name: project_info_cell_arrangement
...
attributes:
  project_oid:
    ...
    from_schema: https://w3id.org/jgi/imgsg_dev
    alias: project_oid
    owner: project_info_cell_arrangement
    domain_of:
    - bioproject_propagation
    - biosample
    - data_quality_flags
