...
URI: [imgsg_dev:BodyProductcv](https://w3id.org/jgi/imgsg_dev/BodyProductcv)
...
```mermaid
 classDiagram
    class BodyProductcv
    click BodyProductcv href "../BodyProductcv/"
      BodyProductcv : cv_term
...
| ---  | ---  |
| self | imgsg_dev:BodyProductcv |
| native | imgsg_dev:BodyProductcv |
