...
URI: [imgsg_dev:Phylogenycv](https://w3id.org/jgi/imgsg_dev/Phylogenycv)
...
```mermaid
 classDiagram
    class Phylogenycv
    click Phylogenycv href "../Phylogenycv/"
      Phylogenycv : cv_term
...
| ---  | ---  |
| self | imgsg_dev:Phylogenycv |
| native | imgsg_dev:Phylogenycv |
