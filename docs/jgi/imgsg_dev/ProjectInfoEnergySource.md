...
# Class: ProjectInfoEnergySource 



URI: [imgsg_dev:ProjectInfoEnergySource](https://w3id.org/jgi/imgsg_dev/ProjectInfoEnergySource)
...
```mermaid
 classDiagram
    class ProjectInfoEnergySource
    click ProjectInfoEnergySource href "../ProjectInfoEnergySource/"
      ProjectInfoEnergySource : energy_source
        
      ProjectInfoEnergySource : project_oid
...
| ---  | ---  |
| self | imgsg_dev:ProjectInfoEnergySource |
| native | imgsg_dev:ProjectInfoEnergySource |
...
<details>
```yaml
name: project_info_energy_source
...
attributes:
  project_oid:
    ...
    from_schema: https://w3id.org/jgi/imgsg_dev
    alias: project_oid
    owner: project_info_energy_source
    domain_of:
    - bioproject_propagation
    - biosample
    - data_quality_flags
