...
# Slot: insert_user_sso 



URI: [imgsg_dev:insert_user_sso](https://w3id.org/jgi/imgsg_dev/insert_user_sso)
...
| ---  | ---  |
| self | imgsg_dev:insert_user_sso |
| native | imgsg_dev:insert_user_sso |
