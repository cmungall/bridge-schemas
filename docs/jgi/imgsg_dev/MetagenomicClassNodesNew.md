...
# Class: MetagenomicClassNodesNew 



URI: [imgsg_dev:MetagenomicClassNodesNew](https://w3id.org/jgi/imgsg_dev/MetagenomicClassNodesNew)
...
```mermaid
 classDiagram
    class MetagenomicClassNodesNew
    click MetagenomicClassNodesNew href "../MetagenomicClassNodesNew/"
      MetagenomicClassNodesNew : ecosystem
        
      MetagenomicClassNodesNew : ecosystem_category
        
      MetagenomicClassNodesNew : ecosystem_subtype
        
      MetagenomicClassNodesNew : ecosystem_type
        
      MetagenomicClassNodesNew : mc_node_id
        
      MetagenomicClassNodesNew : node
        
      MetagenomicClassNodesNew : node_type
        
      MetagenomicClassNodesNew : specific_ecosystem
...
| ---  | ---  |
| self | imgsg_dev:MetagenomicClassNodesNew |
| native | imgsg_dev:MetagenomicClassNodesNew |
...
<details>
```yaml
name: metagenomic_class_nodes_new
...
attributes:
  mc_node_id:
    ...
    from_schema: https://w3id.org/jgi/imgsg_dev
    alias: mc_node_id
    owner: metagenomic_class_nodes_new
    domain_of:
    - metagenomic_class_nodes
    - metagenomic_class_nodes_new
    - metagenomic_class_nodes_new_bk
