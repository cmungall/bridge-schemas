...
# Class: ProjectInfoMetabolism 



URI: [imgsg_dev:ProjectInfoMetabolism](https://w3id.org/jgi/imgsg_dev/ProjectInfoMetabolism)
...
```mermaid
 classDiagram
    class ProjectInfoMetabolism
    click ProjectInfoMetabolism href "../ProjectInfoMetabolism/"
      ProjectInfoMetabolism : metabolism
        
      ProjectInfoMetabolism : project_oid
...
| ---  | ---  |
| self | imgsg_dev:ProjectInfoMetabolism |
| native | imgsg_dev:ProjectInfoMetabolism |
