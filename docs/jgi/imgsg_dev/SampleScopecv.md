...
URI: [imgsg_dev:SampleScopecv](https://w3id.org/jgi/imgsg_dev/SampleScopecv)
...
```mermaid
 classDiagram
    class SampleScopecv
    click SampleScopecv href "../SampleScopecv/"
      SampleScopecv : cv_term
...
| ---  | ---  |
| self | imgsg_dev:SampleScopecv |
| native | imgsg_dev:SampleScopecv |
