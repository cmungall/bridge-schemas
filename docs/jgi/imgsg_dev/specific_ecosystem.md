...
URI: [imgsg_dev:specific_ecosystem](https://w3id.org/jgi/imgsg_dev/specific_ecosystem)
...
| --- | --- | --- |
| [CvspecificEcosystem](CvspecificEcosystem.md) |  |  no  |
...
| ---  | ---  |
| self | imgsg_dev:specific_ecosystem |
| native | imgsg_dev:specific_ecosystem |
