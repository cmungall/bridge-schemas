...
URI: [imgsg_dev:BodySubsitecv](https://w3id.org/jgi/imgsg_dev/BodySubsitecv)
...
```mermaid
 classDiagram
    class BodySubsitecv
    click BodySubsitecv href "../BodySubsitecv/"
      BodySubsitecv : cv_term
...
| ---  | ---  |
| self | imgsg_dev:BodySubsitecv |
| native | imgsg_dev:BodySubsitecv |
