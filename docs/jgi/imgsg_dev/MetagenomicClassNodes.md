...
# Class: MetagenomicClassNodes 



URI: [imgsg_dev:MetagenomicClassNodes](https://w3id.org/jgi/imgsg_dev/MetagenomicClassNodes)
...
```mermaid
 classDiagram
    class MetagenomicClassNodes
    click MetagenomicClassNodes href "../MetagenomicClassNodes/"
      MetagenomicClassNodes : ecosystem
        
      MetagenomicClassNodes : ecosystem_category
        
      MetagenomicClassNodes : ecosystem_subtype
        
      MetagenomicClassNodes : ecosystem_type
        
      MetagenomicClassNodes : mc_node_id
        
      MetagenomicClassNodes : node
        
      MetagenomicClassNodes : node_type
        
      MetagenomicClassNodes : specific_ecosystem
...
| ---  | ---  |
| self | imgsg_dev:MetagenomicClassNodes |
| native | imgsg_dev:MetagenomicClassNodes |
