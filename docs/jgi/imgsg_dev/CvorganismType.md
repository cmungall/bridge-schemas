...
URI: [imgsg_dev:CvorganismType](https://w3id.org/jgi/imgsg_dev/CvorganismType)
...
| ---  | ---  |
| self | imgsg_dev:CvorganismType |
| native | imgsg_dev:CvorganismType |
