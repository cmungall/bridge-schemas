...
# Class: CvecosystemSubtype 



URI: [imgsg_dev:CvecosystemSubtype](https://w3id.org/jgi/imgsg_dev/CvecosystemSubtype)
...
```mermaid
 classDiagram
    class CvecosystemSubtype
    click CvecosystemSubtype href "../CvecosystemSubtype/"
      CvecosystemSubtype : cv_term
        
      CvecosystemSubtype : ecosystem_subtype
...
| ---  | ---  |
| self | imgsg_dev:CvecosystemSubtype |
| native | imgsg_dev:CvecosystemSubtype |
