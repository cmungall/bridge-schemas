...
URI: [imgsg_dev:SubmissionImgContacts](https://w3id.org/jgi/imgsg_dev/SubmissionImgContacts)
...
| ---  | ---  |
| self | imgsg_dev:SubmissionImgContacts |
| native | imgsg_dev:SubmissionImgContacts |
