...
URI: [imgsg_dev:TempRangecv](https://w3id.org/jgi/imgsg_dev/TempRangecv)
...
```mermaid
 classDiagram
    class TempRangecv
    click TempRangecv href "../TempRangecv/"
      TempRangecv : cv_term
...
| ---  | ---  |
| self | imgsg_dev:TempRangecv |
| native | imgsg_dev:TempRangecv |
