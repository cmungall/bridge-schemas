...
URI: [imgsg_dev:SeqStatuscv](https://w3id.org/jgi/imgsg_dev/SeqStatuscv)
...
```mermaid
 classDiagram
    class SeqStatuscv
    click SeqStatuscv href "../SeqStatuscv/"
      SeqStatuscv : cv_term
...
| ---  | ---  |
| self | imgsg_dev:SeqStatuscv |
| native | imgsg_dev:SeqStatuscv |
