...
URI: [imgsg_dev:Phenotypecv](https://w3id.org/jgi/imgsg_dev/Phenotypecv)
...
```mermaid
 classDiagram
    class Phenotypecv
    click Phenotypecv href "../Phenotypecv/"
      Phenotypecv : cv_term
...
| ---  | ---  |
| self | imgsg_dev:Phenotypecv |
| native | imgsg_dev:Phenotypecv |
