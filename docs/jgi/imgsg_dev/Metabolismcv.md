...
URI: [imgsg_dev:Metabolismcv](https://w3id.org/jgi/imgsg_dev/Metabolismcv)
...
```mermaid
 classDiagram
    class Metabolismcv
    click Metabolismcv href "../Metabolismcv/"
      Metabolismcv : cv_term
...
| ---  | ---  |
| self | imgsg_dev:Metabolismcv |
| native | imgsg_dev:Metabolismcv |
