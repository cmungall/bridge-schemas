...
URI: [imgsg_dev:GoldSpGenomePublications](https://w3id.org/jgi/imgsg_dev/GoldSpGenomePublications)
...
| ---  | ---  |
| self | imgsg_dev:GoldSpGenomePublications |
| native | imgsg_dev:GoldSpGenomePublications |
