...
# Class: EnergySourcecv 



URI: [imgsg_dev:EnergySourcecv](https://w3id.org/jgi/imgsg_dev/EnergySourcecv)
...
```mermaid
 classDiagram
    class EnergySourcecv
    click EnergySourcecv href "../EnergySourcecv/"
      EnergySourcecv : cv_term
...
| ---  | ---  |
| self | imgsg_dev:EnergySourcecv |
| native | imgsg_dev:EnergySourcecv |
