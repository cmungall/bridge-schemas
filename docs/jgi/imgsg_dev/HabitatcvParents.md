...
# Class: HabitatcvParents 



URI: [imgsg_dev:HabitatcvParents](https://w3id.org/jgi/imgsg_dev/HabitatcvParents)
...
```mermaid
 classDiagram
    class HabitatcvParents
    click HabitatcvParents href "../HabitatcvParents/"
      HabitatcvParents : cv_term
        
      HabitatcvParents : parents
...
| ---  | ---  |
| self | imgsg_dev:HabitatcvParents |
| native | imgsg_dev:HabitatcvParents |
