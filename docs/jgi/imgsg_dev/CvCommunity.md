...
URI: [imgsg_dev:CvCommunity](https://w3id.org/jgi/imgsg_dev/CvCommunity)
...
```mermaid
 classDiagram
    class CvCommunity
    click CvCommunity href "../CvCommunity/"
      CvCommunity : cv_term
...
| ---  | ---  |
| self | imgsg_dev:CvCommunity |
| native | imgsg_dev:CvCommunity |
