...
# Class: ProjectInfoSeqMethod 



URI: [imgsg_dev:ProjectInfoSeqMethod](https://w3id.org/jgi/imgsg_dev/ProjectInfoSeqMethod)
...
```mermaid
 classDiagram
    class ProjectInfoSeqMethod
    click ProjectInfoSeqMethod href "../ProjectInfoSeqMethod/"
      ProjectInfoSeqMethod : project_oid
        
      ProjectInfoSeqMethod : seq_method
...
| ---  | ---  |
| self | imgsg_dev:ProjectInfoSeqMethod |
| native | imgsg_dev:ProjectInfoSeqMethod |
