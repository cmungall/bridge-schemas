...
# Class: ProjectInfoBodyProducts 



URI: [imgsg_dev:ProjectInfoBodyProducts](https://w3id.org/jgi/imgsg_dev/ProjectInfoBodyProducts)
...
```mermaid
 classDiagram
    class ProjectInfoBodyProducts
    click ProjectInfoBodyProducts href "../ProjectInfoBodyProducts/"
      ProjectInfoBodyProducts : body_product
        
      ProjectInfoBodyProducts : pibp_id
        
      ProjectInfoBodyProducts : project_oid
        
          
    
        
        
        ProjectInfoBodyProducts --> "0..1" ProjectInfo : project_oid
...
| ---  | --- | --- | --- |
| [pibp_id](pibp_id.md) | 0..1 <br/> [Integer](Integer.md) |  | direct |
...
| ---  | ---  |
| self | imgsg_dev:ProjectInfoBodyProducts |
| native | imgsg_dev:ProjectInfoBodyProducts |
...
<details>
```yaml
name: project_info_body_products
...
attributes:
  pibp_id:
    ...
    rank: 1000
    alias: pibp_id
    owner: project_info_body_products
    domain_of:
    - project_info_body_products
    range: integer
    required: false
