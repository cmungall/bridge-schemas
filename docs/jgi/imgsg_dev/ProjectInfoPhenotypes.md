...
# Class: ProjectInfoPhenotypes 



URI: [imgsg_dev:ProjectInfoPhenotypes](https://w3id.org/jgi/imgsg_dev/ProjectInfoPhenotypes)
...
```mermaid
 classDiagram
    class ProjectInfoPhenotypes
    click ProjectInfoPhenotypes href "../ProjectInfoPhenotypes/"
      ProjectInfoPhenotypes : phenotypes
        
      ProjectInfoPhenotypes : project_oid
...
| [phenotypes](phenotypes.md) | 0..1 <br/> [String](String.md) |  | direct |
...
| ---  | ---  |
| self | imgsg_dev:ProjectInfoPhenotypes |
| native | imgsg_dev:ProjectInfoPhenotypes |
