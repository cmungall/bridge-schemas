...
# Class: ProjectMetaUpdates 



URI: [imgsg_dev:ProjectMetaUpdates](https://w3id.org/jgi/imgsg_dev/ProjectMetaUpdates)
...
```mermaid
 classDiagram
    class ProjectMetaUpdates
    click ProjectMetaUpdates href "../ProjectMetaUpdates/"
      ProjectMetaUpdates : project_oid
        
      ProjectMetaUpdates : update_run
...
| [update_run](update_run.md) | 0..1 <br/> [Integer](Integer.md) |  | direct |
...
| ---  | ---  |
| self | imgsg_dev:ProjectMetaUpdates |
| native | imgsg_dev:ProjectMetaUpdates |
