...
URI: [imgsg_dev:project_oid](https://w3id.org/jgi/imgsg_dev/project_oid)
Alias: project_oid
...
| --- | --- | --- |
| [ProjectInfoHabitat](ProjectInfoHabitat.md) |  |  no  |
...
| [ProjectInfoCyanoMetadata](ProjectInfoCyanoMetadata.md) |  |  no  |
| [GenbankRefseqCrossover](GenbankRefseqCrossover.md) |  |  no  |
| [ProjectInfoEnergySource](ProjectInfoEnergySource.md) |  |  no  |
...
| [EnvSampleSoilMetadata](EnvSampleSoilMetadata.md) |  |  no  |
| [ProjectInfoBioproject](ProjectInfoBioproject.md) |  |  no  |
| [ProjectInfoNprodsMetadata](ProjectInfoNprodsMetadata.md) |  |  no  |
| [ProjectInfoPhenotypes](ProjectInfoPhenotypes.md) |  |  no  |
| [ProjectMetaUpdates](ProjectMetaUpdates.md) |  |  no  |
| [ProjectInfoDataLinks](ProjectInfoDataLinks.md) |  |  no  |
| [ProjectInfoCollaborators](ProjectInfoCollaborators.md) |  |  no  |
...
| [DataQualityFlags](DataQualityFlags.md) |  |  no  |
...
| ---  | ---  |
| self | imgsg_dev:project_oid |
| native | imgsg_dev:project_oid |
