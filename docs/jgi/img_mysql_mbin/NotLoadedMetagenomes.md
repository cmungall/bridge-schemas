...
# Class: NotLoadedMetagenomes 



URI: [img_mysql_mbin:NotLoadedMetagenomes](https://w3id.org/jgi/img_mysql_mbin/NotLoadedMetagenomes)
...
```mermaid
 classDiagram
    class NotLoadedMetagenomes
    click NotLoadedMetagenomes href "../NotLoadedMetagenomes/"
      NotLoadedMetagenomes : bin_created_by
        
      NotLoadedMetagenomes : bin_methods
        
      NotLoadedMetagenomes : comment
        
      NotLoadedMetagenomes : num_lq_bins
        
      NotLoadedMetagenomes : processed_date
        
      NotLoadedMetagenomes : taxon_oid
...
| ---  | ---  |
| self | img_mysql_mbin:NotLoadedMetagenomes |
| native | img_mysql_mbin:NotLoadedMetagenomes |
