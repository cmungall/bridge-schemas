...
URI: [img_core_v400:TaxonKoCount](https://w3id.org/jgi/img_core_v400/TaxonKoCount)
...
```mermaid
 classDiagram
    class TaxonKoCount
    click TaxonKoCount href "../TaxonKoCount/"
      TaxonKoCount : data_type
        
      TaxonKoCount : func_id
        
      TaxonKoCount : gene_count
        
      TaxonKoCount : taxon_oid
...
| ---  | ---  |
| self | img_core_v400:TaxonKoCount |
| native | img_core_v400:TaxonKoCount |
