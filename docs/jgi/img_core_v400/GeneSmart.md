...
URI: [img_core_v400:GeneSmart](https://w3id.org/jgi/img_core_v400/GeneSmart)
...
```mermaid
 classDiagram
    class GeneSmart
    click GeneSmart href "../GeneSmart/"
      GeneSmart : align_length
      ...
      GeneSmart : percent_identity
        
      GeneSmart : query_end
        
      GeneSmart : query_start
...
| ---  | ---  |
| self | img_core_v400:GeneSmart |
| native | img_core_v400:GeneSmart |
