...
URI: [img_core_v400:TaxonStats](https://w3id.org/jgi/img_core_v400/TaxonStats)
...
```mermaid
 classDiagram
    class TaxonStats
    click TaxonStats href "../TaxonStats/"
      TaxonStats : cds_genes
        
      TaxonStats : cds_genes_pc
        
      TaxonStats : cog_clusters
        
      TaxonStats : count_go
        
      TaxonStats : crispr_count
        
      TaxonStats : gc_percent
        
      TaxonStats : genes_hor_transfer
        
      TaxonStats : genes_hor_transfer_pc
        
      TaxonStats : genes_in_bcgs
        
      TaxonStats : genes_in_bcgs_pc
        
      TaxonStats : genes_in_cathfunfam
        
      TaxonStats : genes_in_cathfunfam_pc
        
      TaxonStats : genes_in_cog
        
      TaxonStats : genes_in_cog_pc
        
      TaxonStats : genes_in_enzymes
        
      TaxonStats : genes_in_enzymes_pc
        
      TaxonStats : genes_in_kegg
        
      TaxonStats : genes_in_kegg_pc
        
      TaxonStats : genes_in_ko
        
      TaxonStats : genes_in_ko_pc
        
      TaxonStats : genes_in_kog
        
      TaxonStats : genes_in_kog_pc
        
      TaxonStats : genes_in_metacyc
        
      TaxonStats : genes_in_metacyc_pc
        
      TaxonStats : genes_in_myimg
        
      TaxonStats : genes_in_myimg_pc
        
      TaxonStats : genes_in_paralogs
        
      TaxonStats : genes_in_paralogs_pc
        
      TaxonStats : genes_in_pfam
        
      TaxonStats : genes_in_pfam_pc
        
      TaxonStats : genes_in_smart
        
      TaxonStats : genes_in_smart_pc
        
      TaxonStats : genes_in_sp
        
      TaxonStats : genes_in_sp_pc
        
      TaxonStats : genes_in_supfam
        
      TaxonStats : genes_in_supfam_pc
        
      TaxonStats : genes_in_tigrfam
        
      TaxonStats : genes_in_tigrfam_pc
        
      TaxonStats : genes_not_in_kegg
        
      TaxonStats : genes_not_in_kegg_pc
        
      TaxonStats : genes_not_in_ko
        
      TaxonStats : genes_not_in_ko_pc
        
      TaxonStats : genes_not_in_metacyc
        
      TaxonStats : genes_not_in_metacyc_pc
        
      TaxonStats : genes_not_in_sp
        
      TaxonStats : genes_not_in_sp_pc
        
      TaxonStats : genes_obsolete
        
      TaxonStats : genes_obsolete_pc
        
      TaxonStats : genes_revised
        
      TaxonStats : genes_revised_pc
        
      TaxonStats : genes_signalp
        
      TaxonStats : genes_signalp_pc
        
      TaxonStats : genes_transmembrane
        
      TaxonStats : genes_transmembrane_pc
        
      TaxonStats : genes_w_func_pred
        
      TaxonStats : genes_w_func_pred_pc
        
      TaxonStats : kog_clusters
        
      TaxonStats : mod_date
        
      TaxonStats : n_scaffolds
        
      TaxonStats : other_rna_genes
        
      TaxonStats : other_rna_genes_pc
        
      TaxonStats : paralog_groups
        
      TaxonStats : pfam_clusters
        
      TaxonStats : predicted_plasmid_contigs
        
      TaxonStats : pseudo_genes
        
      TaxonStats : pseudo_genes_pc
        
      TaxonStats : rna_genes
        
      TaxonStats : rna_genes_pc
        
      TaxonStats : rrna16s_genes
        
      TaxonStats : rrna16s_genes_pc
        
      TaxonStats : rrna18s_genes
        
      TaxonStats : rrna18s_genes_pc
        
      TaxonStats : rrna23s_genes
        
      TaxonStats : rrna23s_genes_pc
        
      TaxonStats : rrna28s_genes
        
      TaxonStats : rrna28s_genes_pc
        
      TaxonStats : rrna5s_genes
        
      TaxonStats : rrna5s_genes_pc
        
      TaxonStats : rrna_genes
        
      TaxonStats : rrna_genes_pc
        
      TaxonStats : smc_bcgs
        
      TaxonStats : taxon_oid
        
      TaxonStats : tigrfam_clusters
        
      TaxonStats : total_a
        
      TaxonStats : total_bases
        
      TaxonStats : total_bcgs
        
      TaxonStats : total_c
        
      TaxonStats : total_cassettes
        
      TaxonStats : total_coding_bases
        
      TaxonStats : total_g
        
      TaxonStats : total_gatc
        
      TaxonStats : total_gc
        
      TaxonStats : total_gene_count
      ...
      TaxonStats : trna_genes
        
      TaxonStats : trna_genes_pc
        
      TaxonStats : uncharacterized_genes
        
      TaxonStats : uncharacterized_genes_pc
...
| [genes_revised](genes_revised.md) | 0..1 <br/> [Integer](Integer.md) |  | direct |
| [genes_revised_pc](genes_revised_pc.md) | 0..1 <br/> [Integer](Integer.md) |  | direct |
...
| ---  | ---  |
| self | img_core_v400:TaxonStats |
| native | img_core_v400:TaxonStats |
