...
# Class: BiocycProteinSynonyms 



URI: [img_core_v400:BiocycProteinSynonyms](https://w3id.org/jgi/img_core_v400/BiocycProteinSynonyms)
...
```mermaid
 classDiagram
    class BiocycProteinSynonyms
    click BiocycProteinSynonyms href "../BiocycProteinSynonyms/"
      BiocycProteinSynonyms : synonyms
        
      BiocycProteinSynonyms : unique_id
        
          
    
        
        
        BiocycProteinSynonyms --> "0..1" BiocycProtein : unique_id
...
| ---  | ---  |
| self | img_core_v400:BiocycProteinSynonyms |
| native | img_core_v400:BiocycProteinSynonyms |
