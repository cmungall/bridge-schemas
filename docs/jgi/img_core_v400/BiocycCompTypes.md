...
# Class: BiocycCompTypes 



URI: [img_core_v400:BiocycCompTypes](https://w3id.org/jgi/img_core_v400/BiocycCompTypes)
...
```mermaid
 classDiagram
    class BiocycCompTypes
    click BiocycCompTypes href "../BiocycCompTypes/"
      BiocycCompTypes : types
        
      BiocycCompTypes : unique_id
        
          
    
        
        
        BiocycCompTypes --> "0..1" BiocycComp : unique_id
...
| ---  | ---  |
| self | img_core_v400:BiocycCompTypes |
| native | img_core_v400:BiocycCompTypes |
