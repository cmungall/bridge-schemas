...
# Class: TaxonCathfunfamCount 



URI: [img_core_v400:TaxonCathfunfamCount](https://w3id.org/jgi/img_core_v400/TaxonCathfunfamCount)
...
```mermaid
 classDiagram
    class TaxonCathfunfamCount
    click TaxonCathfunfamCount href "../TaxonCathfunfamCount/"
      TaxonCathfunfamCount : data_type
        
      TaxonCathfunfamCount : func_id
        
      TaxonCathfunfamCount : gene_count
        
      TaxonCathfunfamCount : taxon_oid
...
| ---  | ---  |
| self | img_core_v400:TaxonCathfunfamCount |
| native | img_core_v400:TaxonCathfunfamCount |
