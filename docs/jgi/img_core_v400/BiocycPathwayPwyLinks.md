...
# Class: BiocycPathwayPwyLinks 



URI: [img_core_v400:BiocycPathwayPwyLinks](https://w3id.org/jgi/img_core_v400/BiocycPathwayPwyLinks)
...
```mermaid
 classDiagram
    class BiocycPathwayPwyLinks
    click BiocycPathwayPwyLinks href "../BiocycPathwayPwyLinks/"
      BiocycPathwayPwyLinks : pwy_links
        
      BiocycPathwayPwyLinks : unique_id
        
          
    
        
        
        BiocycPathwayPwyLinks --> "0..1" BiocycPathway : unique_id
...
| [pwy_links](pwy_links.md) | 0..1 <br/> [String](String.md) |  | direct |
...
| ---  | ---  |
| self | img_core_v400:BiocycPathwayPwyLinks |
| native | img_core_v400:BiocycPathwayPwyLinks |
...
attributes:
  unique_id:
    ...
    from_schema: https://w3id.org/jgi/img_core_v400
    alias: unique_id
    owner: biocyc_pathway_pwy_links
    domain_of:
    - biocyc_class
    - biocyc_class_parents
    - biocyc_class_synonyms
