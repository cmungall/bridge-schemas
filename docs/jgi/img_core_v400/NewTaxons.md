...
URI: [img_core_v400:NewTaxons](https://w3id.org/jgi/img_core_v400/NewTaxons)
...
```mermaid
 classDiagram
    class NewTaxons
    click NewTaxons href "../NewTaxons/"
      NewTaxons : taxon_name
...
| ---  | ---  |
| self | img_core_v400:NewTaxons |
| native | img_core_v400:NewTaxons |
