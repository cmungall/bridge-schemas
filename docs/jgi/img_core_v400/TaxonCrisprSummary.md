...
# Class: TaxonCrisprSummary 



URI: [img_core_v400:TaxonCrisprSummary](https://w3id.org/jgi/img_core_v400/TaxonCrisprSummary)
...
```mermaid
 classDiagram
    class TaxonCrisprSummary
    click TaxonCrisprSummary href "../TaxonCrisprSummary/"
      TaxonCrisprSummary : contig_id
        
      TaxonCrisprSummary : crispr_no
        
      TaxonCrisprSummary : end_coord
        
      TaxonCrisprSummary : start_coord
        
      TaxonCrisprSummary : taxon_oid
...
| ---  | ---  |
| self | img_core_v400:TaxonCrisprSummary |
| native | img_core_v400:TaxonCrisprSummary |
