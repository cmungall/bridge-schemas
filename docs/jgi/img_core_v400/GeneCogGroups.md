...
URI: [img_core_v400:GeneCogGroups](https://w3id.org/jgi/img_core_v400/GeneCogGroups)
...
```mermaid
 classDiagram
    class GeneCogGroups
    click GeneCogGroups href "../GeneCogGroups/"
      GeneCogGroups : align_length
        
      GeneCogGroups : bit_score
        
      GeneCogGroups : cog
        
      GeneCogGroups : evalue
        
      GeneCogGroups : gene_oid
        
      GeneCogGroups : percent_identity
        
      GeneCogGroups : query_end
        
      GeneCogGroups : query_start
        
      GeneCogGroups : rank_order
        
      GeneCogGroups : scaffold
        
      GeneCogGroups : subj_end
        
      GeneCogGroups : subj_start
...
| ---  | ---  |
| self | img_core_v400:GeneCogGroups |
| native | img_core_v400:GeneCogGroups |
