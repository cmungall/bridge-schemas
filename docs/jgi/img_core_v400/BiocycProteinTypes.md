...
# Class: BiocycProteinTypes 



URI: [img_core_v400:BiocycProteinTypes](https://w3id.org/jgi/img_core_v400/BiocycProteinTypes)
...
```mermaid
 classDiagram
    class BiocycProteinTypes
    click BiocycProteinTypes href "../BiocycProteinTypes/"
      BiocycProteinTypes : types
        
      BiocycProteinTypes : unique_id
        
          
    
        
        
        BiocycProteinTypes --> "0..1" BiocycProtein : unique_id
...
| ---  | ---  |
| self | img_core_v400:BiocycProteinTypes |
| native | img_core_v400:BiocycProteinTypes |
