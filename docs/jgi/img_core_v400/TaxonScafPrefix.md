...
# Class: TaxonScafPrefix 



URI: [img_core_v400:TaxonScafPrefix](https://w3id.org/jgi/img_core_v400/TaxonScafPrefix)
...
```mermaid
 classDiagram
    class TaxonScafPrefix
    click TaxonScafPrefix href "../TaxonScafPrefix/"
      TaxonScafPrefix : data_type
        
      TaxonScafPrefix : id_prefix
        
      TaxonScafPrefix : taxon_oid
...
| ---  | ---  |
| self | img_core_v400:TaxonScafPrefix |
| native | img_core_v400:TaxonScafPrefix |
