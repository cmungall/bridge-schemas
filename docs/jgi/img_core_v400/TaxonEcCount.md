...
URI: [img_core_v400:TaxonEcCount](https://w3id.org/jgi/img_core_v400/TaxonEcCount)
...
```mermaid
 classDiagram
    class TaxonEcCount
    click TaxonEcCount href "../TaxonEcCount/"
      TaxonEcCount : data_type
        
      TaxonEcCount : func_id
        
      TaxonEcCount : gene_count
        
      TaxonEcCount : taxon_oid
...
| ---  | ---  |
| self | img_core_v400:TaxonEcCount |
| native | img_core_v400:TaxonEcCount |
