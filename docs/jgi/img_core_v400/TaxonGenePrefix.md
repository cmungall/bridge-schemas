...
# Class: TaxonGenePrefix 



URI: [img_core_v400:TaxonGenePrefix](https://w3id.org/jgi/img_core_v400/TaxonGenePrefix)
...
```mermaid
 classDiagram
    class TaxonGenePrefix
    click TaxonGenePrefix href "../TaxonGenePrefix/"
      TaxonGenePrefix : data_type
        
      TaxonGenePrefix : id_prefix
        
      TaxonGenePrefix : taxon_oid
...
| [id_prefix](id_prefix.md) | 0..1 <br/> [String](String.md) |  | direct |
...
| ---  | ---  |
| self | img_core_v400:TaxonGenePrefix |
| native | img_core_v400:TaxonGenePrefix |
