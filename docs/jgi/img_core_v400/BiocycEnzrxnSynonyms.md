...
# Class: BiocycEnzrxnSynonyms 



URI: [img_core_v400:BiocycEnzrxnSynonyms](https://w3id.org/jgi/img_core_v400/BiocycEnzrxnSynonyms)
...
```mermaid
 classDiagram
    class BiocycEnzrxnSynonyms
    click BiocycEnzrxnSynonyms href "../BiocycEnzrxnSynonyms/"
      BiocycEnzrxnSynonyms : synonyms
        
      BiocycEnzrxnSynonyms : unique_id
        
          
    
        
        
        BiocycEnzrxnSynonyms --> "0..1" BiocycEnzrxn : unique_id
...
| ---  | ---  |
| self | img_core_v400:BiocycEnzrxnSynonyms |
| native | img_core_v400:BiocycEnzrxnSynonyms |
