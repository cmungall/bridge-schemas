...
# Class: TarballRefreshTaxons 



URI: [img_core_v400:TarballRefreshTaxons](https://w3id.org/jgi/img_core_v400/TarballRefreshTaxons)
...
```mermaid
 classDiagram
    class TarballRefreshTaxons
    click TarballRefreshTaxons href "../TarballRefreshTaxons/"
      TarballRefreshTaxons : taxon_name
        
      TarballRefreshTaxons : taxon_oid
...
| ---  | ---  |
| self | img_core_v400:TarballRefreshTaxons |
| native | img_core_v400:TarballRefreshTaxons |
