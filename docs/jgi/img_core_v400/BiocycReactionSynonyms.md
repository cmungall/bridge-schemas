...
# Class: BiocycReactionSynonyms 



URI: [img_core_v400:BiocycReactionSynonyms](https://w3id.org/jgi/img_core_v400/BiocycReactionSynonyms)
...
```mermaid
 classDiagram
    class BiocycReactionSynonyms
    click BiocycReactionSynonyms href "../BiocycReactionSynonyms/"
      BiocycReactionSynonyms : synonyms
        
      BiocycReactionSynonyms : unique_id
        
          
    
        
        
        BiocycReactionSynonyms --> "0..1" BiocycReaction : unique_id
...
| ---  | ---  |
| self | img_core_v400:BiocycReactionSynonyms |
| native | img_core_v400:BiocycReactionSynonyms |
...
attributes:
  unique_id:
    ...
    from_schema: https://w3id.org/jgi/img_core_v400
    alias: unique_id
    owner: biocyc_reaction_synonyms
    domain_of:
    - biocyc_class
    - biocyc_class_parents
    - biocyc_class_synonyms
