...
# Class: DtPhylodistNewTaxons 



URI: [img_core_v400:DtPhylodistNewTaxons](https://w3id.org/jgi/img_core_v400/DtPhylodistNewTaxons)
...
```mermaid
 classDiagram
    class DtPhylodistNewTaxons
    click DtPhylodistNewTaxons href "../DtPhylodistNewTaxons/"
      DtPhylodistNewTaxons : taxon_name
        
      DtPhylodistNewTaxons : taxon_oid
...
| ---  | ---  |
| self | img_core_v400:DtPhylodistNewTaxons |
| native | img_core_v400:DtPhylodistNewTaxons |
