...
# Class: TaxonTaxonScaffoldInfo 



URI: [img_core_v400:TaxonTaxonScaffoldInfo](https://w3id.org/jgi/img_core_v400/TaxonTaxonScaffoldInfo)
...
```mermaid
 classDiagram
    class TaxonTaxonScaffoldInfo
    click TaxonTaxonScaffoldInfo href "../TaxonTaxonScaffoldInfo/"
      TaxonTaxonScaffoldInfo : max_value
        
      TaxonTaxonScaffoldInfo : min_value
        
      TaxonTaxonScaffoldInfo : scaf_prefix
        
      TaxonTaxonScaffoldInfo : taxon_oid
...
| ---  | ---  |
| self | img_core_v400:TaxonTaxonScaffoldInfo |
| native | img_core_v400:TaxonTaxonScaffoldInfo |
...
<details>
```yaml
name: taxon_taxon_scaffold_info
...
attributes:
  taxon_oid:
    ...
    from_schema: https://w3id.org/jgi/img_core_v400
    alias: taxon_oid
    owner: taxon_taxon_scaffold_info
    domain_of:
    - asv5_taxons
    - bcg_taxons
    - dt_all_phylo_taxon_stats
