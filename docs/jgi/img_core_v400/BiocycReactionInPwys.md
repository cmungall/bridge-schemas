...
# Class: BiocycReactionInPwys 



URI: [img_core_v400:BiocycReactionInPwys](https://w3id.org/jgi/img_core_v400/BiocycReactionInPwys)
...
```mermaid
 classDiagram
    class BiocycReactionInPwys
    click BiocycReactionInPwys href "../BiocycReactionInPwys/"
      BiocycReactionInPwys : in_pwys
        
          
    
        
        
        BiocycReactionInPwys --> "0..1" BiocycPathway : in_pwys
        click BiocycPathway href "../BiocycPathway/"
    

        
      BiocycReactionInPwys : unique_id
        
          
    
        
        
        BiocycReactionInPwys --> "0..1" BiocycReaction : unique_id
...
| [in_pwys](in_pwys.md) | 0..1 <br/> [BiocycPathway](BiocycPathway.md) | Foreign key to biocyc_pathway | direct |
...
| ---  | ---  |
| self | img_core_v400:BiocycReactionInPwys |
| native | img_core_v400:BiocycReactionInPwys |
