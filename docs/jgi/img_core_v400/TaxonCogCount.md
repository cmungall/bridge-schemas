...
URI: [img_core_v400:TaxonCogCount](https://w3id.org/jgi/img_core_v400/TaxonCogCount)
...
```mermaid
 classDiagram
    class TaxonCogCount
    click TaxonCogCount href "../TaxonCogCount/"
      TaxonCogCount : data_type
        
      TaxonCogCount : func_id
        
      TaxonCogCount : gene_count
        
      TaxonCogCount : taxon_oid
...
| ---  | ---  |
| self | img_core_v400:TaxonCogCount |
| native | img_core_v400:TaxonCogCount |
