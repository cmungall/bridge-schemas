...
URI: [img_core_v400:GeneSuperfam](https://w3id.org/jgi/img_core_v400/GeneSuperfam)
...
```mermaid
 classDiagram
    class GeneSuperfam
    click GeneSuperfam href "../GeneSuperfam/"
      GeneSuperfam : align_length
        
      GeneSuperfam : bit_score
        
      GeneSuperfam : db_name
        
      GeneSuperfam : evalue
        
      GeneSuperfam : gene_oid
        
      GeneSuperfam : id
        
      GeneSuperfam : percent_identity
        
      GeneSuperfam : query_end
        
      GeneSuperfam : query_start
        
      GeneSuperfam : scaffold
...
| ---  | ---  |
| self | img_core_v400:GeneSuperfam |
| native | img_core_v400:GeneSuperfam |
