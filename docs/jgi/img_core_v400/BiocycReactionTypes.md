...
# Class: BiocycReactionTypes 



URI: [img_core_v400:BiocycReactionTypes](https://w3id.org/jgi/img_core_v400/BiocycReactionTypes)
...
```mermaid
 classDiagram
    class BiocycReactionTypes
    click BiocycReactionTypes href "../BiocycReactionTypes/"
      BiocycReactionTypes : types
        
      BiocycReactionTypes : unique_id
        
          
    
        
        
        BiocycReactionTypes --> "0..1" BiocycReaction : unique_id
...
| ---  | ---  |
| self | img_core_v400:BiocycReactionTypes |
| native | img_core_v400:BiocycReactionTypes |
