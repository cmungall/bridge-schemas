...
# Class: BiocycProteinInSpecies 



URI: [img_core_v400:BiocycProteinInSpecies](https://w3id.org/jgi/img_core_v400/BiocycProteinInSpecies)
...
```mermaid
 classDiagram
    class BiocycProteinInSpecies
    click BiocycProteinInSpecies href "../BiocycProteinInSpecies/"
      BiocycProteinInSpecies : in_species
        
      BiocycProteinInSpecies : unique_id
        
          
    
        
        
        BiocycProteinInSpecies --> "0..1" BiocycProtein : unique_id
...
| ---  | ---  |
| self | img_core_v400:BiocycProteinInSpecies |
| native | img_core_v400:BiocycProteinInSpecies |
...
<details>
```yaml
name: biocyc_protein_in_species
...
attributes:
  unique_id:
    ...
    from_schema: https://w3id.org/jgi/img_core_v400
    alias: unique_id
    owner: biocyc_protein_in_species
    domain_of:
    - biocyc_class
    - biocyc_class_parents
    - biocyc_class_synonyms
