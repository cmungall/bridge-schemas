...
# Class: BiocycProteinExtLinks 



URI: [img_core_v400:BiocycProteinExtLinks](https://w3id.org/jgi/img_core_v400/BiocycProteinExtLinks)
...
```mermaid
 classDiagram
    class BiocycProteinExtLinks
    click BiocycProteinExtLinks href "../BiocycProteinExtLinks/"
      BiocycProteinExtLinks : db_name
        
      BiocycProteinExtLinks : id
        
      BiocycProteinExtLinks : unique_id
        
          
    
        
        
        BiocycProteinExtLinks --> "0..1" BiocycProtein : unique_id
...
| ---  | ---  |
| self | img_core_v400:BiocycProteinExtLinks |
| native | img_core_v400:BiocycProteinExtLinks |
...
attributes:
  unique_id:
    ...
    from_schema: https://w3id.org/jgi/img_core_v400
    alias: unique_id
    owner: biocyc_protein_ext_links
    domain_of:
    - biocyc_class
    - biocyc_class_parents
    - biocyc_class_synonyms
