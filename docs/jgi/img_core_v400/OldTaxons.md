...
URI: [img_core_v400:OldTaxons](https://w3id.org/jgi/img_core_v400/OldTaxons)
...
```mermaid
 classDiagram
    class OldTaxons
    click OldTaxons href "../OldTaxons/"
      OldTaxons : taxon_name
...
| ---  | ---  |
| self | img_core_v400:OldTaxons |
| native | img_core_v400:OldTaxons |
