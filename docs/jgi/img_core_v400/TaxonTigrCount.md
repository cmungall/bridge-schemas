...
# Class: TaxonTigrCount 



URI: [img_core_v400:TaxonTigrCount](https://w3id.org/jgi/img_core_v400/TaxonTigrCount)
...
```mermaid
 classDiagram
    class TaxonTigrCount
    click TaxonTigrCount href "../TaxonTigrCount/"
      TaxonTigrCount : data_type
        
      TaxonTigrCount : func_id
        
      TaxonTigrCount : gene_count
        
      TaxonTigrCount : taxon_oid
...
| ---  | ---  |
| self | img_core_v400:TaxonTigrCount |
| native | img_core_v400:TaxonTigrCount |
