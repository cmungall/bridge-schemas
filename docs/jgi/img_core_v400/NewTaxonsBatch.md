...
# Class: NewTaxonsBatch 



URI: [img_core_v400:NewTaxonsBatch](https://w3id.org/jgi/img_core_v400/NewTaxonsBatch)
...
```mermaid
 classDiagram
    class NewTaxonsBatch
    click NewTaxonsBatch href "../NewTaxonsBatch/"
      NewTaxonsBatch : taxon_name
        
      NewTaxonsBatch : taxon_oid
...
| ---  | ---  |
| self | img_core_v400:NewTaxonsBatch |
| native | img_core_v400:NewTaxonsBatch |
