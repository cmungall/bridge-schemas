...
# Slot: total_reads_count 



URI: [img_rnaseq:total_reads_count](https://w3id.org/jgi/img_rnaseq/total_reads_count)
...
| ---  | ---  |
| self | img_rnaseq:total_reads_count |
| native | img_rnaseq:total_reads_count |
