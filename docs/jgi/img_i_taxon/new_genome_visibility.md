...
# Slot: new_genome_visibility 



URI: [img_i_taxon:new_genome_visibility](https://w3id.org/jgi/img_i_taxon/new_genome_visibility)
...
| ---  | ---  |
| self | img_i_taxon:new_genome_visibility |
| native | img_i_taxon:new_genome_visibility |
