...
# Slot: refseq_project_id 



URI: [img_i_taxon:refseq_project_id](https://w3id.org/jgi/img_i_taxon/refseq_project_id)
...
| ---  | ---  |
| self | img_i_taxon:refseq_project_id |
| native | img_i_taxon:refseq_project_id |
