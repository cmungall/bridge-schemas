...
# Slot: img_product_flag 



URI: [img_i_taxon:img_product_flag](https://w3id.org/jgi/img_i_taxon/img_product_flag)
...
| ---  | ---  |
| self | img_i_taxon:img_product_flag |
| native | img_i_taxon:img_product_flag |
