...
URI: [img_sub:AnnotationJobSbatchArgs](https://w3id.org/jgi/img_sub/AnnotationJobSbatchArgs)
...
| ---  | ---  |
| self | img_sub:AnnotationJobSbatchArgs |
| native | img_sub:AnnotationJobSbatchArgs |
