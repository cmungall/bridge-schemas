...
URI: [img_sub:AnnotationContigsProteinsCounts](https://w3id.org/jgi/img_sub/AnnotationContigsProteinsCounts)
...
| ---  | ---  |
| self | img_sub:AnnotationContigsProteinsCounts |
| native | img_sub:AnnotationContigsProteinsCounts |
