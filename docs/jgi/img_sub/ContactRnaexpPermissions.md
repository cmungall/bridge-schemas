...
URI: [img_sub:ContactRnaexpPermissions](https://w3id.org/jgi/img_sub/ContactRnaexpPermissions)
...
| ---  | ---  |
| self | img_sub:ContactRnaexpPermissions |
| native | img_sub:ContactRnaexpPermissions |
