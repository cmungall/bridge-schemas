...
URI: [img_sub:KbasePangenomeMembers](https://w3id.org/jgi/img_sub/KbasePangenomeMembers)
...
| ---  | ---  |
| self | img_sub:KbasePangenomeMembers |
| native | img_sub:KbasePangenomeMembers |
