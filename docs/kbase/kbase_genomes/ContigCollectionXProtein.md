...
URI: [https://w3id.org/kbase/kbase_genomes/ContigCollectionXProtein](https://w3id.org/kbase/kbase_genomes/ContigCollectionXProtein)
...
```mermaid
 classDiagram
    ...
    click ContigCollectionXProtein href "../ContigCollectionXProtein/"
      ContigCollectionXProtein : contig_collection_id
        
      ContigCollectionXProtein : protein_id
...
| property | value |
| --- | --- |
| source_table | contig_collection_x_protein |
...
| ---  | ---  |
| self | https://w3id.org/kbase/kbase_genomes/ContigCollectionXProtein |
| native | https://w3id.org/kbase/kbase_genomes/ContigCollectionXProtein |
...
<details>
```yaml
name: ContigCollectionXProtein
annotations:
  source_table:
    tag: source_table
    value: contig_collection_x_protein
...
attributes:
  contig_collection_id:
    ...
    owner: ContigCollectionXProtein
    domain_of:
    - ContigCollection
    - ContigXContigCollection
    - ContigCollectionXEncodedFeature
