...
_Type of cross-reference (UniProt, NCBI, etc.)_





URI: [https://w3id.org/kbase/kbase_uniref50/xref_type](https://w3id.org/kbase/kbase_uniref50/xref_type)
Alias: xref_type
...
| ---  | ---  |
| self | https://w3id.org/kbase/kbase_uniref50/xref_type |
| native | https://w3id.org/kbase/kbase_uniref50/xref_type |
