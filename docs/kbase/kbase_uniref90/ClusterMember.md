...
_Member of a UniRef90 cluster. Links individual protein entities to their parent clusters with membership metadata._





URI: [https://w3id.org/kbase/kbase_uniref90/ClusterMember](https://w3id.org/kbase/kbase_uniref90/ClusterMember)
...
| ---  | ---  |
| self | https://w3id.org/kbase/kbase_uniref90/ClusterMember |
| native | https://w3id.org/kbase/kbase_uniref90/ClusterMember |
...
annotations:
  source_table:
    tag: source_table
    value: clustermember
description: Member of a UniRef90 cluster. Links individual protein entities to their
