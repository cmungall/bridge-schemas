...
_Cross-reference identifier value_





URI: [https://w3id.org/kbase/kbase_uniref90/xref_value](https://w3id.org/kbase/kbase_uniref90/xref_value)
Alias: xref_value
...
| ---  | ---  |
| self | https://w3id.org/kbase/kbase_uniref90/xref_value |
| native | https://w3id.org/kbase/kbase_uniref90/xref_value |
